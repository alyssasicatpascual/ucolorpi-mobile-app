            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _item(context, Icons.favorite_border, 'Health Background', () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (_) => HealthBackgroundScreen(profile: {})));
                  }),

                  const Divider(),

                  _item(context, Icons.lock_outline, 'Privacy Policy', () {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Privacy Policy not implemented')));
                  }),
